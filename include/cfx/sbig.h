...
static inline int8_t cfx_sbig_sign(const cfx_sbig_t *s) {
    return s->sign;
}
static inline int cfx_sbig_is_negative(const cfx_sbig_t *s) {
    return s->sign < 0;
}
static inline int cfx_sbig_is_zero(const cfx_sbig_t *s) {
    return s->sign == 0;
}
static inline int cfx_sbig_is_positive(const cfx_sbig_t *s) {
    return s->sign > 0;
}
static inline const cfx_big_t * cfx_sbig_mag(const cfx_sbig_t *s) {
    return &s->mag;
}
