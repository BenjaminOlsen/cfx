...
/*
 * sc25519.c - Scalar arithmetic modulo the group order L
 *
 * L = 2^252 + 27742317777372353535851937790883648493
 *
 * Based on the SUPERCOP reference implementation approach.
 * Uses radix 2^21 representation with 24 limbs for intermediate values.
 */
 ...
 *
 * Input: s[0]+256*s[1]+...+256^63*s[63] = s (512 bits)
 * Output: s[0]+256*s[1]+...+256^31*s[31] = s mod L (256 bits)
 *
 * L = 2^252 + 27742317777372353535851937790883648493
 */
void cfx_sc25519_reduce(uint8_t out[32], const uint8_t in[64]) {
    ...
    out[0] = (uint8_t)(s0 >> 0);
    out[1] = (uint8_t)(s0 >> 8);
    out[2] = (uint8_t)((s0 >> 16) | (s1 * (1 << 5)));
    out[3] = (uint8_t)(s1 >> 3);
    out[4] = (uint8_t)(s1 >> 11);
    out[5] = (uint8_t)((s1 >> 19) | (s2 * (1 << 2)));
    out[6] = (uint8_t)(s2 >> 6);
    out[7] = (uint8_t)((s2 >> 14) | (s3 * (1 << 7)));
    out[8] = (uint8_t)(s3 >> 1);
    out[9] = (uint8_t)(s3 >> 9);
    out[10] = (uint8_t)((s3 >> 17) | (s4 * (1 << 4)));
    out[11] = (uint8_t)(s4 >> 4);
    out[12] = (uint8_t)(s4 >> 12);
    out[13] = (uint8_t)((s4 >> 20) | (s5 * (1 << 1)));
    out[14] = (uint8_t)(s5 >> 7);
    out[15] = (uint8_t)((s5 >> 15) | (s6 * (1 << 6)));
    out[16] = (uint8_t)(s6 >> 2);
    out[17] = (uint8_t)(s6 >> 10);
    out[18] = (uint8_t)((s6 >> 18) | (s7 * (1 << 3)));
    out[19] = (uint8_t)(s7 >> 5);
    out[20] = (uint8_t)(s7 >> 13);
    out[21] = (uint8_t)(s8 >> 0);
    out[22] = (uint8_t)(s8 >> 8);
    out[23] = (uint8_t)((s8 >> 16) | (s9 * (1 << 5)));
    out[24] = (uint8_t)(s9 >> 3);
    out[25] = (uint8_t)(s9 >> 11);
    out[26] = (uint8_t)((s9 >> 19) | (s10 * (1 << 2)));
    out[27] = (uint8_t)(s10 >> 6);
    out[28] = (uint8_t)((s10 >> 14) | (s11 * (1 << 7)));
 ...
 * s = (a * b + c) mod L
 *
 * Multiply-add for computing s = r + k*a in Ed25519 signatures.
 */
void cfx_sc25519_muladd(uint8_t s[32], const uint8_t a[32], const uint8_t b[32], const uint8_t c[32]) {
    ...
    int64_t carry0, carry1, carry2, carry3, carry4, carry5, carry6, carry7, carry8, carry9, carry10, carry11, carry12, carry13, carry14, carry15, carry16, carry17, carry18, carry19, carry20, carry21, carry22;
